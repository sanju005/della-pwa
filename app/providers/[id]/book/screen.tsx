      ...
      <div className="mx-auto min-h-[100dvh] w-full max-w-[430px] bg-white px-5 pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)]">
        <div className="py-5 pb-36">
          <header className="flex items-center justify-between">
            ...
            <h1 className="text-[18px] font-extrabold tracking-[-0.04em] text-[#0F172A]">
              Book {detail.name}
            </h1>
            <button
              type="button"
          ...
          <section className="mt-5 rounded-[26px] border border-[#E7ECE8] bg-white p-4 shadow-[0_12px_28px_rgba(15,23,42,0.05)]">
            <div className="flex gap-4">
              <div className="relative h-[10.5rem] w-[8.8rem] shrink-0 overflow-hidden rounded-[22px]">
                <Image
                ...
                />
                <div className="absolute bottom-3 left-3 rounded-full bg-[#16A34A] px-3 py-1.5 text-[12px] font-bold text-white">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-start gap-2">
                  <h2 className="truncate text-[18px] font-extrabold tracking-[-0.04em] text-[#0F172A]">
                    {detail.name}
                  </h2>
                  <BadgeCheck className="mt-0.5 h-5 w-5 shrink-0 fill-[#16A34A] text-[#16A34A]" />
                </div>
                ...
                <div className="mt-4 grid grid-cols-2 gap-3 rounded-[18px] bg-[#F7FCF8] px-3 py-3">
                  <div className="flex items-center gap-2 border-r border-[#E4ECE5] pr-2">
                    <span className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-[#E9F8EE] text-[#16A34A]">
          ...
          <section className="mt-6 rounded-[24px] border border-[#E7ECE8] bg-white p-5 shadow-[0_10px_24px_rgba(15,23,42,0.04)]">
            ...
            <div className="mt-5 grid grid-cols-2 gap-3">
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-[#EEF9F1] text-[#16A34A]">
                    <Clock3 className="h-6 w-6" />
                  </span>
                  <span
                    className={`h-7 w-7 rounded-full border-2 ${
                      bookingMode === "hourly"
                        ? "border-[#16A34A] bg-[#16A34A] shadow-[inset_0_0_0_4px_white]"
                        : "border-[#D0D5DD]"
                    }`}
                  />
                </div>
                <p className="mt-4 text-[16px] font-extrabold text-[#0F172A]">Hourly</p>
                <p className="mt-1 text-[15px] text-[#16A34A]">RM{detail.hourlyRate} / hr</p>
              </button>
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-[#F5F7F6] text-[#667085]">
                ...
                <p className="mt-4 text-[16px] font-extrabold text-[#0F172A]">Daily</p>
                <p className="mt-1 text-[15px] text-[#667085]">RM{detail.dailyRate} / day</p>
              </button>
            </div>

            <div className="mt-4 rounded-[16px] border border-[#E8ECE8] bg-[#FBFCFC] px-4 py-3 text-[14px] text-[#475467]">
              {bookingMode === "hourly"
          ...
          <section className="mt-6 rounded-[24px] border border-[#E7ECE8] bg-white p-5 shadow-[0_10px_24px_rgba(15,23,42,0.04)]">
              ...
              <label className="block">
                ...
                <span className="relative block">
                  <select
                    ...
                    className="h-14 w-full appearance-none rounded-[16px] border border-[#E5ECE7] bg-white px-4 pr-10 text-[16px] font-semibold text-[#0F172A] outline-none"
                  >
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <div className="rounded-[18px] bg-[#F6FBF7] px-4 py-4">
                <p className="text-[13px] text-[#667085]">Estimated End Time</p>
                <p className="mt-1 text-[22px] font-extrabold text-[#16A34A]">
                  {computedEndTime}
                </p>
              </div>
              <div className="rounded-[18px] bg-[#F6FBF7] px-4 py-4">
                <p className="text-[13px] text-[#667085]">Duration</p>
                <p className="mt-1 text-[22px] font-extrabold text-[#0F172A]">
          ...
          <section className="mt-6 rounded-[24px] border border-[#E7ECE8] bg-white p-5 shadow-[0_10px_24px_rgba(15,23,42,0.04)]">
            ...
            <textarea
              ...
              className="mt-4 min-h-[8.5rem] w-full rounded-[18px] border border-[#E5ECE7] px-4 py-4 text-[16px] text-[#0F172A] outline-none placeholder:text-[#98A2B3]"
            />
            <p className="mt-2 text-right text-[13px] text-[#667085]">{notes.length}/200</p>
          </section>

          <section className="mt-6 rounded-[24px] border border-[#E7ECE8] bg-[linear-gradient(135deg,#FFFFFF_0%,#F6FFF8_100%)] p-5 shadow-[0_10px_24px_rgba(15,23,42,0.04)]">
            <h2 className="text-[18px] font-extrabold tracking-[-0.04em] text-[#0F172A]">
              Booking Summary
            </h2>
            ...
            <div className="mt-5 border-t border-dashed border-[#D9E3DC] pt-4">
              <div className="flex items-center justify-between">
                <span className="text-[16px] font-semibold text-[#0F172A]">Total</span>
        ...
        <div className="fixed inset-x-0 bottom-0 z-40 mx-auto w-full max-w-[430px] border-t border-[#E8ECE8] bg-white px-5 pb-[calc(1rem+env(safe-area-inset-bottom))] pt-4">
          {error ? (
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              disabled={pending}
              className="inline-flex h-14 min-w-[13rem] items-center justify-center gap-2 rounded-[16px] bg-[#16A34A] px-6 text-[18px] font-extrabold text-white disabled:opacity-70"
            >
              {pending ? "Booking..." : "Book Now"}
              <ChevronRight className="h-5 w-5" />
            </button>
          </div>
          <div className="mt-3 flex items-center justify-center gap-2 text-[14px] text-[#667085]">
